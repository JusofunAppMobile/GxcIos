//
//  UIButton+Verification.m
//  RecruitOnline
//
//  Created by wzh on 2017/6/25.
//  Copyright © 2017年 JUSFOUN. All rights reserved.
//

#import "UIButton+Verification.h"

@implementation UIButton (Verification)
    ...
    dispatch_source_set_event_handler(timer_t, ^{
        if(timeout <= 0){ //倒计时结束，关闭
            ...
            dispatch_async(dispatch_get_main_queue(), ^{//根据自己需求设置倒计时显示
                [self setTitle:[NSString stringWithFormat:@"重新发送(%@S)",strTime] forState:UIControlStateNormal];
