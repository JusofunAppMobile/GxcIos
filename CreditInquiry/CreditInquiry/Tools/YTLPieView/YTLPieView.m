                ...
                downTextItems:(NSArray *)downTextItems
{
    ...
    if (self) {
        ...
        self.pieW = self.pieR - self.pieR/2.0;
...
- (void)drawRect:(CGRect)rect
{
    ...
    for (int i = 0; i < self.dataItems.count; i++)
    {
        ...
        CGFloat picOutR = self.pieR + self.pieW/2.0 ;// 外层半径
        ...
        CGFloat line_1_W = 15;// 1线宽
        CGFloat lineSpace = self.width/2-130;// 终点距两边的距离
        ...
        lineLayer.strokeColor = [UIColor colorWithRed:221/255.0 green:220/255.0 blue:221/255.0 alpha:1.0].CGColor;
    ...
    UILabel *nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(self.width/2-50, self.height/2-50, 100, 100)];
    ...
    [attributedString addAttribute:NSForegroundColorAttributeName value:[UIColor colorWithRed:251/255.0 green:220/255.0 blue:44/255.0 alpha:1.0] range:NSMakeRange(0, string.length-4)];
    
    [attributedString addAttribute:NSForegroundColorAttributeName value:[UIColor colorWithRed:49/255.0 green:49/255.0 blue:49/255.0 alpha:1.0] range:NSMakeRange(string.length-4, 4)];
