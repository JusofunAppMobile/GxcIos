 ...
 */
- (void)commonInit{
    self.changeAxisLineStartXPos =  ZFAxisLineStartXPos;
    _yLineStartXPos = self.changeAxisLineStartXPos;
    ...
    _yLineEndXPos = self.changeAxisLineStartXPos;
...
-(void)setChangeAxisLineStartXPos:(CGFloat)changeAxisLineStartXPos
{
    _changeAxisLineStartXPos = changeAxisLineStartXPos;
    _yLineStartXPos = self.changeAxisLineStartXPos;
    _yLineEndXPos = self.changeAxisLineStartXPos;
}
