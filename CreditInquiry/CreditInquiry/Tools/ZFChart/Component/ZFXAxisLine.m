 ...
 */
- (void)commonInit{
    self.changeAxisLineStartXPos = self.changeAxisLineStartXPos;
    _xLineRightGap = _direction == kAxisDirectionVertical ? ZFAxisXLineRightGapVertical : ZFAxisXLineRightGapHorizontal;
    _xLineWidth = self.frame.size.width - self.changeAxisLineStartXPos - _xLineRightGap;
    _xLineHeight = 1.f;
    
    _xLineStartXPos = self.changeAxisLineStartXPos;
