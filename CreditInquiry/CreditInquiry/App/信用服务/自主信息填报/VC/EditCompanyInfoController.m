...
@interface EditCompanyInfoController ()<UITableViewDelegate,UITableViewDataSource,CreditEditImageCellDelegate>
...
- (void)uploadHeadImage:(UIImage *)image{
    ...
    NSMutableDictionary *params = [NSMutableDictionary dictionary];
    [params setObject:@"logo" forKey:@"type"];
