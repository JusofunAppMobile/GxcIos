       ...
       // self.backgroundColor = [Utility hexStringToColor:@"#d9d9d9"];
        ...
        for (int i=0; i< _itemArray.count; i++) {
           ...
           // NSString *imageNameStr = array.lastObject;
            ...
            SDWebImageManager *manager = [SDWebImageManager sharedManager];
            [manager loadImageWithURL:[NSURL URLWithString:button.squareModel.ItemUrls] options:0 progress:^(NSInteger receivedSize, NSInteger expectedSize, NSURL * _Nullable targetURL) {
