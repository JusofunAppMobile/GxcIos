...
-(void)drawBtnView
{
    ...
    frame.size.height = 10*(height+1) + 30*height + 30 ;
...
- (void)setButtonStyle:(UIButton *)button{
    ...
    if (_type == SearchHistoryType) {
        ...
        [button setTitleColor:KRGB(223, 54, 59) forState:UIControlStateNormal];
        button.layer.borderWidth = .5;
        button.layer.borderColor = KRGB(223, 54, 59).CGColor;
    }
