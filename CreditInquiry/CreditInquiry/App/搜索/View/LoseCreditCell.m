...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        [bgView addSubview:credentialsImage];
        ...
        [bgView addSubview:credentialsLab];
        ...
        [bgView addSubview:numberingImage];
        ...
        [bgView addSubview:numberingLab];
