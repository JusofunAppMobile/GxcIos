...
- (void)setupSubviews{
    ...
    if (KSGuaidManager.shouldDismissWhenDragging == NO) {
        ...
        [self.dismissButton setTitleColor:KHexRGB(0x0d6fe0) forState: UIControlStateNormal];
        self.dismissButton.layer.borderColor = KHexRGB(0x0d6fe0).CGColor;
        self.dismissButton.layer.borderWidth = 1.f;
        self.dismissButton.layer.cornerRadius = 5;
        self.dismissButton.titleLabel.font = KFont(12);
